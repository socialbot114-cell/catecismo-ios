...
- Subtítulo: `Guias de fé e reflexão`
- Categoria principal: `Reference`
...
catecismo,fe,igreja,oracao,catolico,reflexao,leitura,espiritualidade
...
Selecione `Data Not Collected`. O app não coleta, transmite, vende, compartilha ou usa dados pessoais. Não há conta, SDK de anúncio, analytics, rastreamento, backend ou exigência de rede. Progresso e favoritos ficam apenas no dispositivo.
...
Conteúdo religioso/educacional, sem material sensível. Classificação esperada: 4+.
...
1. Início (hero editorial).
2. Biblioteca (lista de guias).
3. Leitura (capítulo com narração).
