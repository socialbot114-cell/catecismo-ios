...
O aplicativo não usa rastreamento, venda de dados ou analytics de terceiros nesta versão. A remoção dos dados locais pode ser feita apagando os dados do aplicativo ou desinstalando-o.

Esta página é um rascunho para revisão jurídica e publicação em uma URL pública antes do envio às lojas.
